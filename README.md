...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>5</td>
            <td>Eu, como sistema, quero consultar uma API OGC do tipo stream, fornecida pelo cliente, para incrementar os dados plotados nas áreas e talhões.</td>
            <td>Consumo de API OGC do Tipo Stream</td>
            <td>2, 3</td>
            <td>Alta</td>
            <td>7</td>
        </tr>
